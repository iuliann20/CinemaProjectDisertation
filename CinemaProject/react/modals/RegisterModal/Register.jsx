...
import { parsedate } from '../../components/Common/Functions';
...
export default function Register() {
    ...
    return (
        <div className="container form-demo">
            ...
            <div className="flex justify-content-center">
                <div className="card" style={{ maxWidth: '400px', width: '100%', margin: 'auto', marginTop: '10px' }}>
                    ...
                    <Form onSubmit={onSubmit} initialValues={{ name: '', email: '', password: '', date: null, country: null, accept: false }} validate={validate} render={({ handleSubmit }) => (
                        <form onSubmit={handleSubmit} className="p-fluid">
                            ...
                            <Field name="phoneNumber" render={({ input, meta }) => (
                                <div className="field">
                                    <span className="p-float-label">
                                        <InputText id="phoneNumber" type='number'  {...input} autoFocus className={classNames({ 'p-invalid': isFormFieldValid(meta) })} />
                            ...
                            <Field name="date" render={({ input, meta }) => (
                                <div className="field">
                                    <span className="p-float-label">
                                        <Calendar id="date" {...input} dateFormat="dd/mm/yy" mask="99/99/9999" showIcon maxDate={maxDate} />
